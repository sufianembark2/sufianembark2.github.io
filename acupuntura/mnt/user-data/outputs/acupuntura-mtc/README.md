...
- **Edición completa (añadir, editar, mover y eliminar):** una vez iniciada
  ...
  - El panel "Editar" (el del botón de arriba) sigue disponible para lo
    ...
    botones inline.
- **Fotos por punto:** en la ficha de cada punto (pestaña "Por punto"),
  si hay fotos guardadas en `images/points/<CÓDIGO>/`, aparecen solas
  debajo en una cuadrícula, con clic para verlas en grande. No hace falta
  tocar el panel de edición — solo crear la carpeta con el código del
  punto y meter las fotos numeradas (`1.jpg`, `2.jpg`...). Instrucciones
  completas en `images/points/README.md`.
